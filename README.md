...
An add-on for [Suntimes](https://github.com/forrestguice/SuntimesWidget) that supplies calendar events for the moon phases, solstices, and equinoxes. This app depends on Suntimes [v0.10.0](https://f-droid.org/en/packages/com.forrestguice.suntimeswidget/) or later.
