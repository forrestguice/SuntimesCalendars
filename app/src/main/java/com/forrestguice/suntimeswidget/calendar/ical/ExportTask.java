...
public abstract class ExportTask extends AsyncTask<Object, Object, ExportTask.ExportResult>
{
    ...
    protected ExportResult doInBackground(Object... params)
    {
        ...
        while ((endTime - startTime) < minWaitTime || isPaused)
        {
    ...
    protected long minWaitTime = MIN_WAIT_TIME;
    ...
    public static void shareResult(Context context, Uri uri, String mimeType)
    {
        Intent shareIntent = new Intent();
        shareIntent.setAction(Intent.ACTION_SEND);
        shareIntent.setType(mimeType);
        ...
        try {
            ...
            context.startActivity(Intent.createChooser(shareIntent, context.getResources().getText(R.string.msg_share_with)));
