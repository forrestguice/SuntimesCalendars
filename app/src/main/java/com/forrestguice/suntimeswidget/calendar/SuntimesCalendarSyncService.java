...
{
    public static final String TAG = "SuntimesCalendarsSync";
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        if (action != null)
        {
            ...
            if (action.equals(ACTION_UPDATE_CALENDARS))
            {
                ...
                runCalendarTask(this, intent, false, false, listener);

            } else if (action.equals(ACTION_CLEAR_CALENDARS)) {
                Log.d(TAG, "onStartCommand: " + action);
                runCalendarTask(this, intent, true, false, listener);
    ...
    private static boolean runCalendarTask(final Context context, Intent intent, boolean clearCalendars, boolean clearPending, @Nullable SuntimesCalendarTask.SuntimesCalendarTaskListener listener)
    {
        ...
        else items = loadItems(intent, clearPending);
